        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Add New Item Category</h1>
                </div>
                ...
                <div class="row" >
                    <div class="breadcrumb-wrapper col-xl-9">
                        <ol class="breadcrumb" style = "background-color:rgba(0, 0, 0, 0);">
                            ...
                            <li class="breadcrumb-item">
                                <a href="<?= base_url('items/Items'); ?>"></i>Item Categories</a>
                            </li>
                            <li class="breadcrumb-item active">Add New Item Category</li>
                        </ol>
                    </div>
                    <div class = "col-xl-3">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="card ">
                            <div class="card-body">
                            <form method="post" action=" <?=base_url('items/Items/submit_added_item_category/')?>" enctype="multipart/form-data">
                            <?= form_open_multipart('') ?>
